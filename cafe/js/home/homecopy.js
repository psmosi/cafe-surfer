  ...
  if (evt.target.matches('.tabs')) {
   ...
   if (evt.target.matches('.Ulsan')
    // && !flag
     ...
     makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod21' }, '남구'),
     makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod21' }, '동구'),
     makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod22' }, '북구'),
     makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod23' }, '중구'),
     makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod24' }, '울주군'),
     );
   ...
   if (evt.target.matches('.Busan')
    // && !flag1
     ...
     const $Ele = makeElement('div', { 'class': 'cont scroll', 'id': 'tab11' },
      ...
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '금정구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '남구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '동구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '동래구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '부산진구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '북구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '사하구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '서구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '연제구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '영도구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '중구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '해운대구'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '기장군'),
      makeElement('a', { 'href': 'javascript:void(0)', 'class': 'tabs2 cod00' }, '북구')
     );
     $tab2box.appendChild($Ele);
     flag1 = true;
