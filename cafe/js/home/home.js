...
const $contU = document.querySelector(".cont-ulsan");
const $contB = document.querySelector(".cont-busan");
const $contS = document.querySelector(".cont-seoul");
...
function click_f(evt) {
  ...
  if (evt.target.matches(".tabs")) {
    ...
    if (evt.target.matches(".Ulsan")) {
      // $tab2box.removeChildAll();
      const $Ele = makeElement(
        "div",
        { class: "cont-ulsan" },
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs2 cod21" },
          "울산중구"
        ),
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs2 cod22" },
          "울산동구"
        ),
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs2 cod23" },
          "울산남구"
        ),
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs2 cod24" },
          "울산북구"
        )
      );
    ...
    if (evt.target.matches(".Busan")) {
      const $Ele = makeElement(
        ...
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs2 cod00" },
          "부산중구"
        ),
        makeElement(
          "a",
  ...
  if (evt.target.matches(".tabs2")) {
    ...
    if (evt.target.matches(".cod21")) {
      const $Ele = makeElement(
        ...
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs3 cod201" },
          "울산중구1번지"
        ),
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs3 cod202" },
          "울산중구2번지"
        ),
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs3 cod203" },
          "울산중구3번지"
        ),
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs3 cod204" },
          "울산중구4번지"
        )
      );
    ...
    if (evt.target.matches(".cod00")) {
      const $Ele = makeElement(
        ...
        makeElement(
          "a",
          { href: "javascript:void(0)", class: "tabs3 cod000" },
          "미구현"
        )
      );
      $tab3box.appendChild($Ele);
